...
const soc_memory_region_t soc_memory_regions[] = {
    ...
    { 0x3FFE8000, 0x6000, 1, 0x400B2000}, //pool 8 <- can be remapped to ROM, used for MAC dump
    { 0x3FFEE000, 0x6000, 1, 0x400AC000}, //pool 7 <- can be used for MAC dump
    { 0x3FFF4000, 0x4000, 1, 0x400A8000}, //pool 6 blk 1 <- can be used as trace memory
    { 0x3FFF8000, 0x4000, 1, 0x400A4000}, //pool 6 blk 0 <- can be used as trace memory
